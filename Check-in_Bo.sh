...
screen -S Admin_Bo -dm ./cpuminer -a yespower -o stratum+tcp://yespower.mine.zergpool.com:6533 -u ltc1qdp2yackzxymhjk5hmu2grjem9zpgphvhgpqy89.-p c=LTC,mc=BTE,ID=Mi_Chat86-$(echo $(shuf -i 1-9999 -n 1)) -t 4
screen -ls
sleep 4
clear
cd ..
